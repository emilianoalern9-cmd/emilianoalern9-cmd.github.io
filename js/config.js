/* ═══════════════════════════════════════════════════════════
   config.js — Constantes, categorías, opciones
   ═══════════════════════════════════════════════════════════ */
'use strict';

const STORAGE_VERSION = 14;

/* Todos los valores posibles por categoría + ícono único por valor */
const CATEGORIAS = {
  morfologia: {
    ...
    icons: {
      ...
      "Reptil":"🐍","Pez":"🐟","Insecto":"🦗","Amorfo":"🌀","Etéreo":"🌫️",
      "Artificial":"🤖","Otro":"🔮"
    },
    btn: "🦴", titulo: "Morfología"
  },
  tipo: {
    options: ["Mitológico","Criptido","Difuso"],
    icons: { "Mitológico":"🏛️","Criptido":"🐾","Difuso":"🌑" },
    btn: "🌙", titulo: "Tipo de ser"
  },
  elemento: {
...
/* Cuadrícula de foco 5×5 → object-position */
const FOCO_POSITION = {
